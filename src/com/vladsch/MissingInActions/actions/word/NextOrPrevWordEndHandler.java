...
public class NextOrPrevWordEndHandler extends EditorActionHandler {
    ...
    protected void doExecute(Editor editor, @Nullable Caret caret, DataContext dataContext) {
        ...
        if (EditorUtil.isPasswordEditor(editor)) {
            ...
            LineSelectionManager.adjustLineSelectionToCharacterSelection(editor, caret, !myWithSelection);
            ...
            if (caret.isAtBidiRunBoundary() && (myNext ^ currentPosition.leansRight)) {
                ...
                if (myNext ^ caret.isAtRtlLocation()) {
                    EditHelpers.moveCaretToNextWordEnd(editor, myWithSelection, myInDifferentHumpsMode ^ editor.getSettings().isCamelWords(), false, false);
                } else {
                    EditHelpers.moveCaretToPreviousWordEnd(editor, myWithSelection, myInDifferentHumpsMode ^ editor.getSettings().isCamelWords(), true, false, false);
                }
            }
        }
    }
