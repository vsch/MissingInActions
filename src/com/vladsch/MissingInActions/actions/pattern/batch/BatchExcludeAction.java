...
public class BatchExcludeAction extends DumbAwareTextComponentEditorAction {
    public BatchExcludeAction() {
        super(new BatchActionHandler(BatchReplaceForm.EXCLUDE));
    }
}
