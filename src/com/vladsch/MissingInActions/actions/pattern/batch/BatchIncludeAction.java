...
public class BatchIncludeAction extends DumbAwareTextComponentEditorAction {
    public BatchIncludeAction() {
        super(new BatchActionHandler(BatchReplaceForm.INCLUDE));
    }
}
