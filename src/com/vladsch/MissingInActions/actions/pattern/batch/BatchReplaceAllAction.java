...
public class BatchReplaceAllAction extends DumbAwareTextComponentEditorAction {
    public BatchReplaceAllAction() {
        super(new BatchActionHandler(BatchReplaceForm.REPLACE_ALL));
    }
}
