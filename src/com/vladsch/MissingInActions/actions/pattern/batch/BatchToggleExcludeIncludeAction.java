...
public class BatchToggleExcludeIncludeAction extends DumbAwareTextComponentEditorAction {
    public BatchToggleExcludeIncludeAction() {
        super(new BatchActionHandler(BatchReplaceForm.TOGGLE_EXCLUDE_INCLUDE));
    }
}
