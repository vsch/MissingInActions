...
public class BatchFindNextAction extends DumbAwareTextComponentEditorAction {
    public BatchFindNextAction() {
        super(new BatchActionHandler(BatchReplaceForm.FIND_NEXT));
    }
}
