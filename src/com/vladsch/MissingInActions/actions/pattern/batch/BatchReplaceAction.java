...
public class BatchReplaceAction extends DumbAwareTextComponentEditorAction {
    public BatchReplaceAction() {
        super(new BatchActionHandler(BatchReplaceForm.REPLACE));
    }
}
