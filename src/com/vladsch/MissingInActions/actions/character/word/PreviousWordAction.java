...
public class PreviousWordAction extends DumbAwareTextComponentEditorAction implements LineSelectionAware {
    public PreviousWordAction() {
        super(new NextOrPrevWordHandler(false, false, false));
    }
}
