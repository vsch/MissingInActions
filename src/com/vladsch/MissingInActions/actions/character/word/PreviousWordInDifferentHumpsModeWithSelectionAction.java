...
public class PreviousWordInDifferentHumpsModeWithSelectionAction extends DumbAwareTextComponentEditorAction implements LineSelectionAware {
    public PreviousWordInDifferentHumpsModeWithSelectionAction() {
        super(new NextOrPrevWordHandler(false, true, true));
    }
}
