...
public class PreviousWordWithSelectionAction extends DumbAwareTextComponentEditorAction implements LineSelectionAware {
    public PreviousWordWithSelectionAction() {
        super(new NextOrPrevWordHandler(false, true, false));
    }
}
