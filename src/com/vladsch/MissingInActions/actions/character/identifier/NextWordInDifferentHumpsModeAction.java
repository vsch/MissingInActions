...
public class NextWordInDifferentHumpsModeAction extends DumbAwareTextComponentEditorAction implements LineSelectionAware {
    public NextWordInDifferentHumpsModeAction() {
        super(new NextOrPrevWordHandler(true, false, true));
    }
}
