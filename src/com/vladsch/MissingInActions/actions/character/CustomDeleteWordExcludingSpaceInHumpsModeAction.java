...
public class CustomDeleteWordExcludingSpaceInHumpsModeAction extends DumbAwareTextComponentEditorAction {
    public CustomDeleteWordExcludingSpaceInHumpsModeAction() {
        super(new DeleteRegExActionHandler(new RegExProvider(), false, DeleteRegExActionHandler.HumpsMode.FOLLOW));
    }
