...
public class CustomBackspaceWordExcludingSpaceInHumpsModeAction extends DumbAwareTextComponentEditorAction {
    public CustomBackspaceWordExcludingSpaceInHumpsModeAction() {
