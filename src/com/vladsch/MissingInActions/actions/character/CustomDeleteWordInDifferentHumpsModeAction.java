...
public class CustomDeleteWordInDifferentHumpsModeAction extends DumbAwareTextComponentEditorAction {
    public CustomDeleteWordInDifferentHumpsModeAction() {
    ...
    static class RegExProvider implements RegExDeleteProvider {
        ...
        public String getRegEx() {
            return ApplicationSettings.getInstance().getDeleteWordRegEx();
        }
