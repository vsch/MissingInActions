...
public class PageUpWithLineSelectionAction extends SelectionActionAdjustWrapperBase {
    public PageUpWithLineSelectionAction() {
        super(new PageUpWithSelectionAction());
    }
}
