...
public abstract class ComboBoxAction extends AnAction implements CustomComponentAction {
    ...
    private static String COMBO_BOX_EDITOR_PROPERTY = "COMBO_BOX_EDITOR_PROPERTY";
    ...
    @NotNull
    abstract protected DefaultActionGroup createPopupActionGroup(JComponent button, @Nullable Editor editor);
    ...
    protected class ComboBoxButton extends JButton implements UserActivityProviderComponent {
        ...
        protected JBPopup createPopup(Runnable onDispose) {
            ...
            popup.addListener(new JBPopupListener() {
                @Override
                public void beforeShown(final LightweightWindowEvent event) {
                    popupStart(ComboBoxButton.this, editor);
                }

                @Override
                public void onClosed(final LightweightWindowEvent event) {
                    popupDone(ComboBoxButton.this, editor);
                }
            });
            return popup;
        }
