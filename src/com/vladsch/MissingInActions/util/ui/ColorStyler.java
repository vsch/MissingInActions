...
public class ColorStyler extends HtmlStylerBase<java.awt.Color> {
    @Override
    public String getStyle(final java.awt.Color item) {
    ...
    public static Integer getNamedColor(final @Nullable String colorName) {
        return nameColorMap.get(colorName);
    }

    @Nullable
    public static String getColorName(@Nullable java.awt.Color item) {
        return item != null ? colorNameMap.get(item.getRGB() & 0x00ffffff) : null;
    }

    @NotNull
    public static String getColorValue(@Nullable java.awt.Color item) {
    ...
    @NotNull
    public static String getColorNameOrRGB(@Nullable java.awt.Color item) {
        if (item != null) {
    ...
    private static void addColorName(int rgb, @NotNull String name) {
